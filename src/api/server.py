...
async def startup_event():
    ...
    try:
        ...
        print("      Loading local Nemotron streaming model...")
        ...
        print("      Please check:")
        print("        - NeMo-Speech runtime is present")
        print("        - Nemotron GGUF model is present")
...
async def get_status():
    ...
    audio_stats = {
        ...
        "asr_ready": audio_service.asr_ready if audio_service else False,
        "model_path": audio_service.model_path if audio_service else None,
        "hotword_count": audio_service.hotword_count if audio_service else 0,
        "last_error": audio_service.last_error if audio_service else None,
